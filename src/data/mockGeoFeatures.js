...
export const geoFeatures = {
  ...
  // features配列は、地理的な特徴（国や地域など）のコレクションを表します。
  features: [
    {
      type: "Feature",
      // propertiesオブジェクトは、地理的特徴の詳細情報を含みます。ここでは「name」プロパティが国名を示しています。
      properties: {
        name: "Afghanistan",
      // geometryオブジェクトは、地理的特徴の形状や座標を定義します。この例では「Polygon」タイプが使われており、国の境界線を表しています。
      },
      geometry: {
        type: "Polygon",
          // 座標の配列は、ポリゴンの各頂点を示し、国の境界線を形成します。
          // 例：[61.210817, 35.650072], [62.230651, 35.270664], ...
        coordinates: [
          [
            [61.210817, 35.650072],
            [62.230651, 35.270664],
    ...
    },
    {
      ...
      geometry: {
        type: "MultiPolygon",// 複数のポリゴンを含む地理的特徴を表す。
        coordinates: [
          // 複数のポリゴンの座標配列。
          [
            [
